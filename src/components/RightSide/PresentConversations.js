    ...
    return (
      <>
        <Grid container>
            ...
            <Switch>
                  <Route path="https://rajattiwari20.github.io/React-chat-app/user2" exact>
                    <CurrentConversation userId = {2} />
                  </Route>

                  <Route path="https://rajattiwari20.github.io/React-chat-app/user3" exact>
                    <CurrentConversation userId = {3}  />
                  </Route>
                  
                  <Route path="https://rajattiwari20.github.io/React-chat-app/user4" exact>
                    <CurrentConversation userId = {4}  />
                  </Route>
                  
                  <Route path="https://rajattiwari20.github.io/React-chat-app/user5" exact>
                    <CurrentConversation userId = {5}  />
                  </Route>
                  
                  <Route path="https://rajattiwari20.github.io/React-chat-app/user6" exact>
